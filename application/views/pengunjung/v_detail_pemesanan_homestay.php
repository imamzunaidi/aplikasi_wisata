                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <?php if ( $detail_pemesanan_homestay->status_pemesanan == 'lakukan pembayaran') { ?>
                                <div class="col-md-8">
                                    <div class="row">
                            ...
                            <?php }else if($detail_pemesanan_homestay->status_pemesanan == 'lunas' || $detail_pemesanan_homestay->status_pemesanan == 'penuh' || $detail_pemesanan_homestay->status_pemesanan == 'menunggu konfirmasi'){ ?>
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12 mt-2">
                                            <h5>Data Pemesan</h5>
