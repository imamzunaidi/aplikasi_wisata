<div class="page-content">
    <div class="checkout">
        <div class="container mt-5">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <h2 class="checkout-title">Daftar Kuliner</h2><!-- End .checkout-title -->
                        <form action="<?= base_url('pengunjung/data_pemesanan_kuliner/add_kuliner')?>" method="post">
                            <div class="row">

                                <div class="col-sm-8">
                                    <label>Kuliner *</label>
                                    <select name="id_kuliner" class = "form-control" id="" required>
                                        <option value="">--Pilih Kuliner--</option>
                                        <?php foreach ($data_kuliner as $key => $value) { ?>
                                            <option value="<?= $value->id_kuliner?>"><?= $value->nama_kuliner?></option>
                                        <?php } ?>
                                    </select>
                                </div><!-- End .col-sm-6 -->
                                ...
                                <div class="col-sm-4">
                                    <label>Qty *</label>
                                    <input type="text" class="form-control" name = "qty" v required>
                                </div><!-- End .col-sm-6 -->
                                        ...
                                        <?php foreach ($this->cart->contents() as $items): 
                                            ...
                                            <tr>
                                                ...
                                                <td class = "text-center" width = "15%">
                                                    <a href="<?= base_url('pengunjung/data_pemesanan_kuliner/delete_kuliner/'.$items['rowid'])?>" class="btn-custom btn-danger btn-sm p-3"><i class="icon-close"></i></a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
                        ...
                        <form action="<?= base_url('pengunjung/data_pemesanan_kuliner/insert')?>" method="post">
                        ...
                        <aside class="col-lg-3">
                            <div class="summary">
                                ...
                                <?php foreach ($this->cart->contents() as $items):  
                                    $total += $items['subtotal']; ?>
                                    <input type="hidden" name = "id_kuliner[]" value = "<?= $items['id']?>">
