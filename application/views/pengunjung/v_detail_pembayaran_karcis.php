                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Nama *</label>
                                        <input type="text" class="form-control" name = "nama_pemesan" value = "<?= $detail_pembayaran_karcis->nama_pemesan?>" required readonly>
                                    </div><!-- End .col-sm-6 -->

                                    <div class="col-sm-6">
                                        <label>No Telp Member *</label>
                                        <input type="text" class="form-control" name = "no_telp_pemesan" value = "<?= $detail_pembayaran_karcis->no_telp_pemesan?>" required readonly>
                                    </div><!-- End .col-sm-6 -->
                                    <div class="col-sm-6">
                                        <label>Email *</label>
                                        <input type="text" class="form-control" name = "nama_pemesan" value = "<?= $detail_pembayaran_karcis->email_member?>" required readonly>
                                    </div><!-- End .col-sm-6 -->

                                    <div class="col-sm-6">
                                        <label>No Telp Member *</label>
                                        <input type="text" class="form-control" name = "no_telp_pemesan" value = "<?= $detail_pembayaran_karcis->alamat_member?>" required readonly>
                                    </div><!-- End .col-sm-6 -->
                                </div><!-- End .row -->
                            ...
                            <div class="col-md-4">
                                ...
                                <form action="<?= base_url('pengunjung/Data_pembayaran/pembayaran_homestay')?>" method="post"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="pembayaran" id="" class="form-control" value = "<?= $detail_pembayaran_karcis->total_harga?>" placeholder="" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Pembayaran</label>
                                        <img src="<?= base_url()?>assets/img/pembayaran/<?= $detail_pembayaran_karcis->bukti_bayar?>" alt="" width ="100%">
                                    </div>
