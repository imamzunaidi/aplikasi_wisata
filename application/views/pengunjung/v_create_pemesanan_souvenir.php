<div class="page-content">
    <div class="checkout">
        <div class="container mt-5">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <h2 class="checkout-title">Daftar Souvenir</h2><!-- End .checkout-title -->
                        <form action="<?= base_url('pengunjung/data_pemesanan_souvenir/add_souvenir')?>" method="post">
                            <div class="row">

                                <div class="col-sm-8">
                                    <label>Souvenir *</label>
                                    <select name="id_souvenir" class = "form-control" id="" required>
                                        <option value="">--Pilih Souvenir--</option>
                                        <?php foreach ($data_souvenir as $key => $value) { ?>
                                            <option value="<?= $value->id_souvenir?>"><?= $value->nama_souvenir?></option>
                                        <?php } ?>
                                    </select>
                                </div><!-- End .col-sm-6 -->
                                        ...
                                        <?php foreach ($this->cart->contents() as $items): 
                                            ...
                                            <tr>
                                                ...
                                                <td class = "text-center" width = "15%">
                                                    <a href="<?= base_url('pengunjung/data_pemesanan_souvenir/delete_souvenir/'.$items['rowid'])?>" class="btn-custom btn-danger btn-sm p-3"><i class="icon-close"></i></a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
                        ...
                        <form action="<?= base_url('pengunjung/data_pemesanan_souvenir/insert')?>" method="post">
                        ...
                        <aside class="col-lg-3">
                            <div class="summary">
                                ...
                                <?php foreach ($this->cart->contents() as $items):  
                                    $total += $items['subtotal']; ?>
                                    <input type="hidden" name = "id_souvenir[]" value = "<?= $items['id']?>">
