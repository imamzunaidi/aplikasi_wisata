                                    ...
                                    <tr>
                                        ...
                                        foreach ($data_pemesanan_kuliner as $key => $value) { ?>
                                            <tr class ="text-center">
                                                ...
                                                <td>
                                                <a href="<?= base_url('pengunjung/Data_riwayat_kuliner/detail_pembayaran_kuliner/' . $value->id_pemesanan_kuliner) ?>" class="btn-custom btn-info btn-sm p-3"><i class="fas fa-eye"></i></a>
