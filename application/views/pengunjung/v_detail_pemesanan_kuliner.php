                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <h5 class = "mt-2">Data Pembayaran</h5>
                                <form action="<?= base_url('pengunjung/Data_pembayaran/pembayaran_kuliner')?>" method="post"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="pembayaran" id="" class="form-control" value = "<?= $detail_pemesanan_kuliner->total_harga?>" placeholder="" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Upload Bukti Bayar</label>
                                        <input type="file" name="gambar" id="" class="form-control" placeholder="" >
                                        <input type="hidden" name = "id_pemesanan_kuliner" value = "<?= $detail_pemesanan_kuliner->id_pemesanan_kuliner?>">
                                    </div>
