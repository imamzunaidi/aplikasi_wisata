                                    ...
                                    <tr>
                                        ...
                                        foreach ($data_pemesanan_karcis as $key => $value) { ?>
                                            <tr class ="text-center">
                                                ...
                                                <td>
                                                <a href="<?= base_url('pengunjung/Data_riwayat_karcis/detail_pembayaran_karcis/' . $value->id_pemesanan_karcis) ?>" class="btn-custom btn-info btn-sm p-3"><i class="fas fa-eye"></i></a>
