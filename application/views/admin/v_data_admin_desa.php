              ...
              <?php $no = 1;
                ...
                <tr>
                  ...
                  <td class ="text-center"> 
                    ...
                    <a href="<?= base_url('admin/data_admin_desa/delete/' . $value->id_users) ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
...
<div class="modal fade" id="tambahdata" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/data_admin_desa/insert') ?>" method="post" enctype='multipart/form-data'>
...
<div class="modal fade" id="updatedata<?= $value->id_users?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/data_admin_desa/update') ?>" method="post" enctype='multipart/form-data'>
        <div class="modal-body">
